...
7 - BSSID
[{RED}*{CYAN}] Made by {RED}@Its_n03uTuB{CYAN} Telegram: {RED}@eby_talents (Subscribe) {CYAN}
''')
...
{CYAN}[{RED}*{CYAN}] Possible names: {GREEN}{name}
	"""
			...
			print(f'{CYAN}[{RED}-{CYAN}] Неправильно написано. ¯╲_(ツ)_/¯')
	elif shell == '3':
